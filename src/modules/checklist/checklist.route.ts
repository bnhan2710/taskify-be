...
ChecklistRoute.get('/',
    checkAuth,
    asyncHandler(ChecklistController.getCheckListbyCard))
//GET CHECKLIST BY ID
ChecklistRoute.get('/:id',
    checkAuth, 
    asyncHandler(ChecklistController.getChecklistbyId))
//UPDATE checkAuth
ChecklistRoute.put('/:id', 
    checkAuth, 
    validate(updateChecklistValidation),
    asyncHandler(ChecklistController.updateChecklist))
//DELETE checkAuth
ChecklistRoute.delete('/:id', 
    checkAuth, 
    asyncHandler(ChecklistController.removeChecklist))
