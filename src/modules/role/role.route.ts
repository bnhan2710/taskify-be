...
router.get('/permission-of-role/:id'
    ,asyncHandler(RoleController.GetPermissionofRole))
//CREATE ROLE
router.post('/',
...
router.delete('/permission-of-role',
    asyncHandler(RoleController.DeletePermissionfromRole))
//DELETE PERMISSION
router.delete('/permission',
    asyncHandler(RoleController.DeletePermission))
//DELETE ROLL
router.delete('/',
